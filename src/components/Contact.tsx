                ...
                <div className="contact-wrapper">
                    <div className="contact-info glass-card animate-fade-up">
                        ...
                        <div className="contact-methods">
                            <a href="mailto:kavinuthepul456@gmail.com" className="contact-method">
                            ...
                            <a href="https://www.linkedin.com/in/kavinuv" target="_blank" rel="noopener noreferrer" className="contact-method">
                                <div className="method-icon">
                                    <Linkedin size={24} />
                                </div>
                                <div className="method-details">
                            ...
                            <a href="https://github.com/kavinu1" target="_blank" rel="noopener noreferrer" className="contact-method">
                                <div className="method-icon">
                                    <Github size={24} />
                                </div>
                                <div className="method-details">
                    ...
                    <form className="contact-form glass-card animate-fade-up" style={{ animationDelay: '0.2s' }} onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <textarea id="message" name="message" rows={5} placeholder="Execute connection request..." required></textarea>
                        </div>
