        ...
        <section className="hero" id="home">
            ...
            <div className="container hero-content">
                ...
                <p className="hero-subtitle animate-fade-up animate-delay-2">
                    Computer Science student focused on cloud infrastructure, CI/CD, and containerization. Seeking a DevOps Engineering internship for my Year 3 industrial placement.
                </p>
                ...
                <div className="hero-tech-stack animate-fade-up animate-delay-4">
                    <div className="tech-item"><Server size={18} /> Kubernetes</div>
                    <div className="tech-item"><Terminal size={18} /> Linux</div>
                    <div className="tech-item"><GitBranch size={18} /> Git & GitHub</div>
                    <div className="tech-item"><Code size={18} /> Node.js</div>
                </div>
            </div>

            <a href="#about" className="scroll-indicator animate-fade-up animate-delay-4">
                <div className="mouse">
